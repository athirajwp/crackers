            ...
            <div x-show="modalOpen" x-transition class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white border border-slate-200 rounded-3xl shadow-2xl sm:my-8 sm:align-middle sm:max-w-5xl sm:w-full">
                ...
                <form id="company-form" action="/admin_sys/company" :action="isEditMode ? '/admin_sys/company/' + form.id + '/update' : '/admin_sys/company'" method="POST" enctype="multipart/form-data" class="p-6 space-y-7 text-xs font-semibold max-h-[80vh] overflow-y-auto">
                        ...
                        <div class="border border-slate-150 rounded-2xl p-4 bg-slate-50/50 space-y-4">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                <div class="relative">
                                    ...
                                    <input type="text" name="bank_name_<?php echo e($b); ?>" x-model="form.bank_name_<?php echo e($b); ?>" class="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none">
                                </div>
                                <div class="relative">
                                    ...
                                    <input type="text" name="bank_ifsc_<?php echo e($b); ?>" x-model="form.bank_ifsc_<?php echo e($b); ?>" class="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none font-mono uppercase">
                                </div>
                                <div class="relative">
                                    ...
                                    <input type="text" name="bank_acc_<?php echo e($b); ?>" x-model="form.bank_acc_<?php echo e($b); ?>" class="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none font-mono">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                <div class="relative">
                                    ...
                                    <input type="text" name="bank_branch_<?php echo e($b); ?>" x-model="form.bank_branch_<?php echo e($b); ?>" class="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none">
                                </div>
                                <div class="relative">
                                    ...
                                    <input type="text" name="bank_type_<?php echo e($b); ?>" x-model="form.bank_type_<?php echo e($b); ?>" class="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none">
                                </div>
                                <div class="relative">
                                    ...
                                    <input type="text" name="bank_holder_<?php echo e($b); ?>" x-model="form.bank_holder_<?php echo e($b); ?>" class="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none">
                                </div>
                            </div>
                        </div>
                        <?php endfor; ?>
                    ...
                    <div class="flex justify-end gap-3 pt-5 border-t border-slate-150 select-none">
                        ...
                        <button type="submit" class="bg-<?php echo e($currentTheme['accent']); ?> hover:bg-<?php echo e($currentTheme['accent_hover']); ?> text-<?php echo e($theme === 'gold' ? 'slate-950' : 'white'); ?> font-extrabold px-6 py-2.5 rounded-xl transition-all shadow shadow-<?php echo e($currentTheme['accent']); ?>/10 select-none">
