...
<body>
    <div class="wrapper">
        <div class="container">
            <!-- Header -->
            <div class="header">
                <h1><?php echo e(strtoupper(App\Models\Setting::get('store_name', 'Cracker Store'))); ?></h1>
            ...
            <div class="content">
                        ...
                        <td>
                            <div class="info-card">
                                ...
                                <?php if($order->whatsapp): ?>
                                    <strong>WhatsApp:</strong> <?php echo e($order->whatsapp); ?><br>
                                <?php endif; ?>
                                <?php if($order->email): ?>
                                    <strong>Email:</strong> <a href="mailto:<?php echo e($order->email); ?>" style="color: #b91c1c; text-decoration: none;"><?php echo e($order->email); ?></a>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
                            <div class="info-card" style="padding-left: 15px; padding-right: 0;">
                                ...
                                <strong>Preferred Lorry:</strong> <?php echo e($order->transport_name ?: 'Not Specified'); ?><br>
                ...
                <table class="items-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="desc-col"><?php echo e($item->product_name); ?></td>
                            <td style="text-align: center; color: #64748b; font-size: 12px;"><?php echo e($item->pack_size); ?></td>
                            <td class="qty-col"><?php echo e($item->quantity); ?></td>
                            <td class="price-col">₹<?php echo e(number_format($item->total_price, 2)); ?></td>
                        </tr>
                ...
                <table class="totals-table">
                    <tr>
                        ...
                        <td style="text-align: right; width: 100px; font-weight: 600;">₹<?php echo e(number_format($order->subtotal, 2)); ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td style="text-align: right; font-weight: 500;">Wholesale Discount:</td>
                        <td style="text-align: right; font-weight: 600; color: #16a34a;">-₹<?php echo e(number_format($order->discount_amount, 2)); ?></td>
                    </tr>
                    <tr class="grand-total">
                        <td></td>
                        <td style="text-align: right;">Net Payable:</td>
                        <td style="text-align: right;" class="amount">₹<?php echo e(number_format($order->net_amount, 2)); ?></td>
                    </tr>
                </table>
            ...
            <div class="footer">
                ...
                <strong><?php echo e(App\Models\Setting::get('store_name', 'Cracker Store')); ?></strong> | <a href="<?php echo e(config('app.url')); ?>/admin">Go to Dashboard</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/emails/admin_invoice.blade.php ENDPATH**/ ?>