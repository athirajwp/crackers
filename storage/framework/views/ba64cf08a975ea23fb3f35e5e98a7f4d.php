...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col font-sans selection:bg-gold-500 selection:text-slate-900">
    ...
    <div class="bg-crimson-700 border-b border-crimson-800 text-white py-2 text-xs font-semibold marquee-container shadow-sm select-none">
        <div class="marquee-content flex gap-12 items-center">
            ...
            <span><i class="fa-solid fa-phone text-gold-300 mr-2"></i>For Enquiries, Contact Support: <strong><?php echo e(App\Models\Setting::get('store_phone', '+91 9998887776')); ?></strong></span>
    ...
    <header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80 shadow-sm">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center gap-2 md:gap-3 flex-shrink-0">
                <a href="tel:<?php echo e(App\Models\Setting::get('store_phone', '+919998887776')); ?>" class="hidden lg:flex items-center gap-2 bg-slate-100 border border-slate-200 hover:border-slate-300 px-3.5 py-1.5 rounded-full text-xs font-bold text-slate-700 hover:bg-slate-200 transition-all shadow-sm">
                    <i class="fa-solid fa-phone text-crimson-600"></i>
                    <span><?php echo e(App\Models\Setting::get('store_phone', '+91 9998887776')); ?></span>
                </a>
                
                <!-- Desktop WhatsApp Button -->
                <a href="https://wa.me/<?php echo e(App\Models\Setting::get('store_whatsapp', '919998887776')); ?>" target="_blank" class="hidden sm:flex bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-1.5 rounded-full text-xs font-extrabold items-center gap-1.5 shadow-sm hover:scale-105 transition-all">
                    <i class="fa-brands fa-whatsapp text-sm"></i>
                    <span>WhatsApp Booking</span>
                </a>
                
                <!-- Mobile Compact WhatsApp Button (Icon only) -->
                <a href="https://wa.me/<?php echo e(App\Models\Setting::get('store_whatsapp', '919998887776')); ?>" target="_blank" class="sm:hidden flex bg-emerald-600 hover:bg-emerald-500 text-white w-8 h-8 rounded-xl items-center justify-center shadow-sm hover:scale-105 transition-all" title="WhatsApp Booking">
                    <i class="fa-brands fa-whatsapp text-base"></i>
                </a>
                
                <!-- Admin login shortcut (Hidden on mobile header, available in mobile dropdown) -->
                <a href="<?php echo e(route('admin.login')); ?>" class="hidden sm:inline-flex text-slate-400 hover:text-slate-650 p-1.5 rounded-lg text-sm transition-colors" title="Admin Portal">
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="border-t border-slate-100 pt-3 flex flex-col gap-2">
                <a href="tel:<?php echo e(App\Models\Setting::get('store_phone', '+919998887776')); ?>" class="w-full flex items-center justify-center gap-2 bg-slate-100 border border-slate-200 px-3.5 py-2.5 rounded-full text-xs font-bold text-slate-700 hover:bg-slate-200 transition-all shadow-sm">
                    <i class="fa-solid fa-phone text-crimson-600"></i>
                    <span>Call Support: <?php echo e(App\Models\Setting::get('store_phone', '+91 9998887776')); ?></span>
                </a>
            </div>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-extrabold text-lg text-slate-800"><?php echo e(strtoupper(App\Models\Setting::get('store_name', 'Cracker Demo'))); ?></span>
                    </div>
...
<?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/layouts/app.blade.php ENDPATH**/ ?>