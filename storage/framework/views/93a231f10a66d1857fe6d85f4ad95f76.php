<?php $__env->startSection('title', 'Wholesale Price List | ' . App\Models\Setting::get('store_name', 'Cracker Demo')); ?>
...
<div class="container mx-auto max-w-4xl px-4 py-8 select-none">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center bg-white border border-slate-200 rounded-2xl p-5 shadow-sm mb-8 gap-4 print:hidden">
        <div>
            ...
            <p class="text-xs text-slate-500 font-semibold uppercase tracking-wider mt-1">Official Price Registry - Flat <?php echo e($settings['discount_percent']); ?>% Discount Applied</p>
        </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-slate-200 pb-6 mb-6 gap-4">
            <div>
                <h1 class="text-2xl font-black tracking-tight text-crimson-700 uppercase leading-none">
                    <?php echo e(App\Models\Setting::get('store_name', 'Cracker Demo')); ?>
            ...
            <div class="text-xs text-slate-500 font-semibold space-y-1">
                <div><i class="fa-solid fa-phone text-crimson-600 mr-1.5 text-[10px]"></i><strong>Phone:</strong> <?php echo e($settings['store_phone']); ?></div>
                <div><i class="fa-solid fa-envelope text-crimson-600 mr-1.5 text-[10px]"></i><strong>Email:</strong> <?php echo e($settings['store_email']); ?></div>
                <div><i class="fa-solid fa-map-marker-alt text-crimson-600 mr-1.5 text-[10px]"></i><strong>Address:</strong> <?php echo e($settings['store_address']); ?></div>
            </div>
        </div>
            ...
            <table class="w-full text-left text-xs border-collapse">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-200 text-slate-650 font-extrabold uppercase tracking-wider text-[9px]">
                        ...
                        <th class="py-3 px-4 w-24 text-right">Discount (<?php echo e($settings['discount_percent']); ?>% Off)</th>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="bg-slate-100/60 font-black text-slate-700 text-[10px] uppercase tracking-wider border-y border-slate-200">
                            <td colspan="6" class="py-3.5 px-4">
                                <i class="fa-solid fa-circle-chevron-right text-crimson-600 mr-2 text-[9px]"></i><?php echo e($category->name); ?>
                        ...
                        <tr class="hover:bg-slate-50/40 transition-colors">
                            <td class="py-3 px-3 sm:px-4 text-center font-mono font-bold text-slate-400"><?php echo e($sno++); ?></td>
                            <td class="py-3 px-4 font-bold text-slate-800"><?php echo e($product->name); ?></td>
                            <td class="py-3 px-4 text-center font-mono text-slate-500 font-bold"><?php echo e($product->pack_size); ?></td>
                            <td class="py-3 px-4 text-right line-through text-slate-400 font-mono">₹<?php echo e(number_format($product->mrp, 2)); ?></td>
                            <td class="py-3 px-4 text-right text-emerald-600 font-mono">₹<?php echo e(number_format($product->mrp * ($settings['discount_percent'] / 100), 2)); ?></td>
                            <td class="py-3 px-4 text-right pr-6 font-extrabold text-crimson-600 font-mono">₹<?php echo e(number_format($product->selling_price, 2)); ?></td>
                        </tr>
...
<script>
    function downloadPDF() {
        ...
        const storeName = "<?php echo e(App\Models\Setting::get('store_name', 'Cracker_Demo')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/price_list.blade.php ENDPATH**/ ?>