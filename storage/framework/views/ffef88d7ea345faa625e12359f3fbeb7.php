    ...
    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
        ...
        <div class="mb-5 flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <div class="text-[10px] text-slate-400 font-bold uppercase tracking-wider flex items-center gap-1.5 bg-slate-50 border border-slate-150 px-3 py-1.5 rounded-lg shadow-sm">
                ...
                <span x-text="searchQuery.trim() === '' ? <?php echo e($products->count()); ?> : Object.values(matches).filter(Boolean).length" class="text-slate-700 font-extrabold font-mono"></span> of <span class="text-slate-700 font-extrabold font-mono"><?php echo e($products->count()); ?></span> items matching
            </div>
        </div>
            ...
            <table class="w-full text-left text-xs border-collapse">
                ...
                <tbody class="divide-y divide-slate-150 text-slate-650 font-semibold">
                    <?php if($products->count() > 0): ?>
                        ...
                        <tr x-show="isMatch(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', '<?php echo e(addslashes($product->category->name)); ?>', '<?php echo e(addslashes($product->pack_size)); ?>')" class="hover:bg-slate-50/50">
                            ...
                            <td class="py-3 px-4 flex items-center gap-3">
                                ...
                                <div class="space-y-1">
                                    <strong class="text-slate-800 font-extrabold text-xs leading-normal select-all block"><?php echo e($product->name); ?></strong>
                                    <!-- Responsive inline badges on mobile -->
                                    <div class="flex flex-wrap items-center gap-1.5 sm:hidden">
                                        <span class="text-[8px] font-bold text-slate-400 bg-slate-100 border border-slate-150 px-1 py-0.5 rounded uppercase tracking-wider"><?php echo e($product->category->name); ?></span>
                                        <span class="text-[8px] font-bold text-slate-550 bg-slate-100 border border-slate-150 px-1.5 py-0.5 rounded font-mono"><?php echo e($product->pack_size); ?></span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-4 text-center pr-4">
                                <div class="inline-flex gap-2">
                                    <button @click="editItem = { 
                                                ...
                                                sort_order: <?php echo e($product->sort_order); ?>, 
