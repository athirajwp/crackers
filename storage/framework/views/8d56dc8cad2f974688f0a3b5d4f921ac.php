<?php $__env->startSection('title', 'About Us | ' . App\Models\Setting::get('store_name', 'Cracker Demo') . ' Sivakasi'); ?>
    ...
    <section class="relative bg-white border-b border-slate-200 overflow-hidden py-20">
        ...
        <div class="container mx-auto px-4 text-center relative z-10 space-y-4">
            ...
            <h2 class="text-4xl md:text-5xl font-black tracking-tight text-slate-900 leading-tight">
                About <?php echo e(App\Models\Setting::get('store_name', 'Cracker Demo')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative group">
                ...
                <div class="relative bg-white border border-slate-200 p-3.5 rounded-3xl shadow-lg overflow-hidden transform group-hover:scale-[1.01] transition-transform duration-300">
                    ...
                    <?php if($aboutImg1 || $aboutImg2 || $aboutImg3): ?>
                        <div class="grid grid-cols-2 gap-3">
                            <div class="col-span-2 overflow-hidden rounded-xl aspect-[16/10] bg-slate-50 border border-slate-100 shadow-sm">
                                <img src="/<?php echo e($aboutImg1 ?: ($aboutImg2 ?: $aboutImg3)); ?>" alt="Sivakasi Fireworks Showcase 1" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
                            </div>
                            <?php if($aboutImg2): ?>
                            <div class="overflow-hidden rounded-xl aspect-[4/3] bg-slate-50 border border-slate-100 shadow-sm">
                                <img src="/<?php echo e($aboutImg2); ?>" alt="Sivakasi Fireworks Showcase 2" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
                            </div>
                            <?php endif; ?>
                            <?php if($aboutImg3): ?>
                            <div class="overflow-hidden rounded-xl aspect-[4/3] bg-slate-50 border border-slate-100 shadow-sm <?php echo e(!$aboutImg2 ? 'col-span-2' : ''); ?>">
                                <img src="/<?php echo e($aboutImg3); ?>" alt="Sivakasi Fireworks Showcase 3" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
                            </div>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
            ...
            <div class="space-y-6">
                ...
                <div class="pt-4 border-t border-slate-100 flex flex-wrap gap-6 text-xs text-slate-650 font-bold">
                    ...
                    <div class="flex items-center gap-2">
                        <i class="fa-solid fa-square-check text-emerald-600 text-lg"></i>
                        <span>Flat <?php echo e(App\Models\Setting::get('discount_percent', 60)); ?>% Wholesale Savings</span>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-gradient-to-tr from-slate-900 via-slate-800 to-slate-950 text-white py-16 relative overflow-hidden select-none shadow-inner border-y border-slate-900">
        ...
        <div class="container mx-auto px-4 text-center max-w-2xl relative z-10 space-y-6">
            ...
            <div class="pt-4 flex flex-wrap justify-center gap-4">
                <a href="https://wa.me/<?php echo e(App\Models\Setting::get('store_whatsapp', '919998887776')); ?>" target="_blank" class="bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-3 rounded-full text-xs font-extrabold flex items-center gap-2 shadow shadow-emerald-950/20 transform active:scale-95 transition-all">
    ...
    <section class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gradient-to-tr from-gold-50/50 to-crimson-50/50 border border-slate-200/60 p-6 rounded-2xl shadow-sm flex flex-col justify-center items-center text-center space-y-4">
                ...
                <h4 class="font-extrabold text-sm text-slate-850 uppercase tracking-widest"><?php echo e(App\Models\Setting::get('store_name', 'Cracker Demo')); ?></h4>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div class="lg:col-span-5 flex flex-col justify-between space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white border border-slate-200 p-4 rounded-2xl shadow-sm flex items-start gap-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-xs text-slate-700 leading-normal font-bold">
                                <?php echo e(App\Models\Setting::get('store_address', 'Virudhunagar to Sivakasi Main Road, Sivakasi')); ?>
                    ...
                    <!-- Call Card -->
                    <a href="tel:<?php echo e(App\Models\Setting::get('store_phone')); ?>" class="bg-white border border-slate-200 hover:border-slate-350 p-4 rounded-2xl shadow-sm flex items-start gap-4 hover:scale-[1.01] transition-transform">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-xs text-slate-700 leading-normal font-bold">
                                <?php echo e(App\Models\Setting::get('store_phone', '+91 9998887776')); ?>
                    ...
                    <!-- Email Card -->
                    <a href="mailto:<?php echo e(App\Models\Setting::get('store_email')); ?>" class="bg-white border border-slate-200 hover:border-slate-300 p-4 rounded-2xl shadow-sm flex items-start gap-4 hover:scale-[1.01] transition-transform">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-xs text-slate-700 leading-normal font-bold">
                                <?php echo e(App\Models\Setting::get('store_email', 'crackerdemo@gmail.com')); ?>
                    ...
                    <!-- WhatsApp Card -->
                    <a href="https://wa.me/<?php echo e(App\Models\Setting::get('store_whatsapp', '919998887776')); ?>" target="_blank" class="bg-emerald-50/50 border border-emerald-100 hover:border-emerald-200 p-4 rounded-2xl shadow-sm flex items-start gap-4 hover:scale-[1.01] transition-transform">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/about.blade.php ENDPATH**/ ?>