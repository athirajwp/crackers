    ...
    <div class="w-full max-w-md px-6 relative z-10">
        ...
        <div class="glass-box p-10 rounded-3xl space-y-7 text-slate-800">
            ...
            <div class="bg-crimson-50 border border-crimson-200 text-crimson-750 p-3.5 rounded-xl text-xs font-semibold flex items-start gap-2.5 shadow-sm">
                ...
                <span><?php echo e($errors->first('auth_failed')); ?></span>
            </div>
            <?php endif; ?>

            <!-- Form -->
            <form action="<?php echo e(route('admin_sys.login.post')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/admin_sys/login.blade.php ENDPATH**/ ?>