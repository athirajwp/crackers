    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm flex items-center justify-between gap-4">
            <div class="space-y-1">
                ...
                <strong class="text-2xl font-black text-slate-800 font-mono"><?php echo e($stats['total_orders']); ?></strong>
            </div>
        ...
        <div class="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm flex items-center justify-between gap-4">
            <div class="space-y-1">
                ...
                <strong class="text-2xl font-black text-amber-600 font-mono"><?php echo e($stats['pending_orders']); ?></strong>
            </div>
        ...
        <div class="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm flex items-center justify-between gap-4">
            <div class="space-y-1">
                ...
                <strong class="text-2xl font-black text-emerald-600 font-mono">₹<?php echo e(number_format($stats['total_revenue'], 2)); ?></strong>
            </div>
        ...
        <div class="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm flex items-center justify-between gap-4">
            <div class="space-y-1">
                ...
                <strong class="text-2xl font-black text-crimson-650 font-mono">₹<?php echo e(number_format($stats['pending_revenue'], 2)); ?></strong>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
            <div class="flex justify-between items-center border-b border-slate-200 pb-4">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="bg-slate-50 hover:bg-slate-100 border border-slate-200 px-3.5 py-1.5 rounded-full text-[10px] font-bold text-slate-600 transition-colors uppercase tracking-widest">
                    ...
                    <tbody class="divide-y divide-slate-150 text-slate-650 font-semibold">
                        <?php if($recentOrders->count() > 0): ?>
                            ...
                            <tr class="hover:bg-slate-50/50">
                                <td class="py-3.5 px-4 font-mono font-bold tracking-wider text-slate-800 select-all"><?php echo e($order->order_number); ?></td>
                                <td class="py-3.5 px-4">
                                    <div class="font-extrabold text-slate-800"><?php echo e($order->name); ?></div>
                                    <div class="text-[10px] text-slate-450 font-mono select-all"><?php echo e($order->phone); ?></div>
                                </td>
                                <td class="py-3.5 px-4 text-right font-extrabold text-crimson-650">₹<?php echo e(number_format($order->net_amount, 2)); ?></td>
                                <td class="py-3.5 px-4 text-center">
                                    <span class="px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider shadow-sm <?php echo e($order->order_status_badge); ?>">
                                        <?php echo e($order->order_status); ?>

                                    </span>
                                </td>
                                <td class="py-3.5 px-4 text-center pr-4">
                                    <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="inline-flex items-center justify-center bg-slate-50 hover:bg-slate-100 border border-slate-200 w-8 h-8 rounded-lg text-slate-600 hover:text-slate-900 transition-colors shadow-sm" title="Manage Order">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div class="space-y-3.5 text-xs">
                <!-- Manage Inventory -->
                <a href="<?php echo e(route('admin.products.index')); ?>" class="w-full flex items-center justify-between p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl transition-all shadow-sm group">
                ...
                <!-- Store Settings -->
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="w-full flex items-center justify-between p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl transition-all shadow-sm group">
                    <div class="flex items-center gap-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>