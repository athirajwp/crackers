        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div class="border-t border-slate-200 pt-5 space-y-4">
                <h4 class="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5">
                    <i class="fa-solid fa-toggle-on text-<?php echo e($currentTheme['accent']); ?>"></i> Cart & Checkout Features
                </h4>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <select name="enable_min_order" class="w-full bg-slate-50 border border-slate-200 focus:border-<?php echo e($currentTheme['accent']); ?> focus:bg-white rounded-xl px-3.5 py-2.5 text-xs text-slate-800 focus:outline-none transition-all">
                            <option value="yes" <?php echo e(($settings['enable_min_order'] ?? 'yes') === 'yes' ? 'selected' : ''); ?>>Yes (Enforced)</option>
                            <option value="no" <?php echo e(($settings['enable_min_order'] ?? 'yes') === 'no' ? 'selected' : ''); ?>>No (Disabled)</option>
                        </select>
                    </div>
                    <div class="space-y-1.5">
                        <label class="block text-[9px] font-bold text-slate-500 uppercase tracking-wider mb-1 px-0.5">Enable Promo Code Input</label>
                        <select name="enable_promo_codes" class="w-full bg-slate-50 border border-slate-200 focus:border-<?php echo e($currentTheme['accent']); ?> focus:bg-white rounded-xl px-3.5 py-2.5 text-xs text-slate-800 focus:outline-none transition-all">
                            <option value="yes" <?php echo e(($settings['enable_promo_codes'] ?? 'yes') === 'yes' ? 'selected' : ''); ?>>Yes (Show Coupons)</option>
                            <option value="no" <?php echo e(($settings['enable_promo_codes'] ?? 'yes') === 'no' ? 'selected' : ''); ?>>No (Hide Coupons)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <select name="enable_tax_delivery" class="w-full bg-slate-50 border border-slate-200 focus:border-<?php echo e($currentTheme['accent']); ?> focus:bg-white rounded-xl px-3.5 py-2.5 text-xs text-slate-800 focus:outline-none transition-all">
                            <option value="yes" <?php echo e(($settings['enable_tax_delivery'] ?? 'no') === 'yes' ? 'selected' : ''); ?>>Yes (Calculate)</option>
                            <option value="no" <?php echo e(($settings['enable_tax_delivery'] ?? 'no') === 'no' ? 'selected' : ''); ?>>No (Free / Exclude)</option>
                        </select>
                    </div>
                    <div class="space-y-1.5">
