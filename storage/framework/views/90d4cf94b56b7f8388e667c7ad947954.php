<?php $__env->startSection('title', 'Terms & Conditions | ' . App\Models\Setting::get('store_name', 'Cracker Demo') . ' Sivakasi'); ?>
    ...
    <section class="container mx-auto px-4 py-12 max-w-4xl">
        <div class="bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm relative overflow-hidden">
                ...
                <?php else: ?>
                    ...
                    <div class="space-y-8 text-slate-550 font-medium">
                        ...
                        <div class="space-y-3">
                            ...
                            <p>
                                <?php echo e(App\Models\Setting::get('store_name', 'Cracker Demo')); ?> Sivakasi is solely a merchant supplier and assumes no civil or criminal liability for physical damage, injury, or loss of life resulting from improper or negligent handling of purchased items.
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <div class="border-t border-slate-100 mt-10 pt-6 flex justify-between items-center text-[10px] text-slate-400 select-none">
                <span>Last updated: <?php echo e(date('F Y')); ?></span>
                <span><?php echo e(App\Models\Setting::get('store_name', 'Cracker Demo')); ?> Sivakasi</span>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/terms.blade.php ENDPATH**/ ?>