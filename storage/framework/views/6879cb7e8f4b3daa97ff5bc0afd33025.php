...
<head>
    ...
    <title>Admin Login | <?php echo e($storeName); ?></title>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        active: {
                            50: '<?php echo e($activeTheme['bg_50']); ?>',
                            500: '<?php echo e($activeTheme['primary']); ?>',
                            600: '<?php echo e($activeTheme['primary_dark']); ?>',
                            700: '<?php echo e($activeTheme['primary_darker']); ?>',
                        },
                        gold: {
                            50: '#fffdf0',
                            100: '#fef7c3',
    ...
    <style>
        .glass-box {
            ...
            border: 1px solid <?php echo e($activeTheme['glass_border']); ?>;
        ...
        .sparkle-dot {
            ...
            width: 6px;
            height: 6px;
            background-color: <?php echo e($activeTheme['primary']); ?>;
            border-radius: 50%;
            filter: drop-shadow(0 0 4px <?php echo e($activeTheme['primary']); ?>);
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex items-center justify-center font-sans relative overflow-hidden select-none">
    ...
    <div class="absolute w-[600px] h-[600px] bg-[radial-gradient(circle,_<?php echo e($activeTheme['glow']); ?>_0%,_rgba(0,0,0,0)_70%)] -top-44 -left-44 pointer-events-none"></div>
    ...
    <div class="w-full max-w-sm px-4 relative z-10">
        ...
        <div class="glass-box p-8 rounded-3xl space-y-6">
            ...
            <div class="text-center space-y-3">
                <a href="/<?php echo e($currentCompany ? '?company=' . $currentCompany->code : ''); ?>" class="inline-flex items-center justify-center p-4 bg-gradient-to-tr from-active-500 to-active-600 rounded-2xl shadow-md hover:scale-105 transition-transform duration-300 <?php echo e($activeTheme['btn_text']); ?>">
                    <i class="fa-solid fa-lock-keyhole text-2xl"></i>
                </a>
                <div>
                    <h2 class="text-lg font-black tracking-wider uppercase text-slate-850 pt-1 leading-tight"><?php echo e($storeName); ?></h2>
            ...
            <!-- Auth Form -->
            <form action="<?php echo e(route('admin.login.post', ['company' => $currentCompany?->code])); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-active-500 to-active-600 hover:from-active-600 hover:to-active-700 <?php echo e($activeTheme['btn_text']); ?> font-extrabold py-3.5 rounded-xl text-xs uppercase tracking-wider shadow-md transform active:scale-95 transition-all flex items-center justify-center gap-1.5 pt-4">
            ...
            <div class="text-center">
                <a href="/<?php echo e($currentCompany ? '?company=' . $currentCompany->code : ''); ?>" class="text-[10px] font-bold text-slate-500 hover:text-active-600 transition-colors uppercase tracking-widest"><i class="fa-solid fa-arrow-left mr-1"></i> Back to store</a>
            </div>
...
<?php /**PATH C:\Users\Athi\OneDrive\Desktop\crackers\resources\views/admin/login.blade.php ENDPATH**/ ?>