...
<body>
    ...
    <div class="invoice-container">
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right" style="padding-top: 15px;">MRP Sum:</td>
                    <td class="text-right" style="padding-top: 15px;">₹{{ number_format($order->subtotal, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="4" style="border: none;"></td>
        ...
        <div class="footer-note">
            ...
            1. All Sivakasi crackers are packed and sealed in durable wooden/cardboard cartons.<br>
            2. Damages, leaking, or transport logistics delays are to be settled directly with the third-party lorry transport agents. We observe pure packaging protocols.<br>
